...
Cette première cartographie des corrélations apparaît peu lisible. En effet, toutes les variables ou presque sont fortement corrélées. Cela est dû au fait que certains départements produisent beaucoup et d'autres moins. Ainsi, dans un département où il y a des nombreuses créations d'entreprises en énergie, il y en aura également beaucoup dans d'autres secteurs comme la finance ou l'environnement. Cela signifie qu'il s'agit d'un département plutôt porteur en termes de créations d'entreprises. Les corrélations entre les deux périodes sont difficiles à observer ici.
...
Paris, qui est un département particulièrement productif, prend des valeurs très élevées sur l'axe 1. Ainsi, sa présence altère la visualisation des autres départements, qui sont tous regroupés.
